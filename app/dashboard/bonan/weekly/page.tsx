...
export default function BonanWeeklyPage() {
  return (
    <div className="min-h-screen bg-(--bg)">
      <div className="max-w-4xl mx-auto px-4 py-6 space-y-4">
        <p className="text-xs font-semibold uppercase tracking-[0.15em] text-(--text)/55">Bonan Towers</p>
        <h1 className="text-2xl font-bold text-(--text)">Weekly Systems</h1>
        <div className="tl-card p-6">
          <p className="text-sm text-(--text)/70">
            Weekly workflows will include sprinkler pump room logs and linked Sunday-Saturday daily report rollups.
          </p>
          <Link
